              ...
              <CardContainer className="inter-var">
                <CardBody className="group/card relative h-auto w-auto rounded-xl border border-neutral-800 bg-neutral-900 p-6">
                  ...
                  <CardItem translateZ="100" className="mt-4 w-full">
                    <div className="relative h-48 w-full overflow-hidden rounded-lg bg-gradient-to-br from-rose-500/20 to-amber-500/20">
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <CardItem
                          translateZ={20}
                          as="button"
                          className="rounded-lg bg-gradient-to-r from-rose-500 to-amber-500 px-4 py-2 text-sm font-bold text-white"
                        >
                          View Details
                        </CardItem>
                      </DialogTrigger>
